...
<p class="text-center">
<a href="/projects/DATAIKUOCRDEMO/dashboards/Hsi5bIw_football-match-predictions-dashboard/view/wiT0cTb"  class="btn btn-datasets-color btn-cta-big-mod"><i class="icon-dku-sample_project" class="btn-cta-big-mod-icon" />Dashboard</a>
</p>

The [dashboard](dashboard:moj9XTy) shows a view of the input PDFs and output files. The [scenario](scenario:ProcessDocument) to process the input PDFs can also be triggered from here.